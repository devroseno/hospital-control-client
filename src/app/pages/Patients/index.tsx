                ...
                >
                    <thead>
                        <tr className='fw-bolder text-muted'>
                            <th className='min-w-150px'>{intl.formatMessage({ id: "TABLE.TH.NAME" })}</th>
                            <th className='min-w-120px'>{intl.formatMessage({ id: "TABLE.TH.CPF" })}</th>
                            <th className='min-w-120px'>{intl.formatMessage({ id: "TABLE.TH.WHATSAPP" })}</th>
                            <th className='min-w-150px'>{intl.formatMessage({ id: "TABLE.TH.AGE" })}</th>
                            <th className='min-w-100px text-end'>{intl.formatMessage({ id: "TABLE.TH.ACTIONS" })}</th>
                        </tr>
                    </thead>
                        ...
                        <tr>
                            <td>
                                ...
                                <div className='d-flex justify-content-start flex-column'>
                                    <span className='text-dark fw-bolder text-hover-primary fs-6'>Carlos Daniel</span>
                            ...
                            <td>
                                <div className='d-flex justify-content-end flex-shrink-0'>
                                    <Button
                                        ...
                                        title={intl.formatMessage({id: "BUTTON.TITLE.ATTENDANCE" })}
                                    >
                                    ...
                                    <Button
                                        ...
                                        title={intl.formatMessage({id: "BUTTON.TITLE.DELETE" })}
                                    >
